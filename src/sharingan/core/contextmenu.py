...
class HookRightClick(idaapi.UI_Hooks):
    def finish_populating_widget_popup(self, widget, popup, ctx):
        if idaapi.get_widget_type(widget) == idaapi.BWN_DISASM:
            idaapi.attach_action_to_popup(widget, popup, BOOKMARK_LIST, SHARINGAN_MENU, 0)
            idaapi.attach_action_to_popup(widget, popup, REVERT, SHARINGAN_MENU, 0)
            idaapi.attach_action_to_popup(widget, popup, FILTER, SHARINGAN_MENU, 0)
        return 0
